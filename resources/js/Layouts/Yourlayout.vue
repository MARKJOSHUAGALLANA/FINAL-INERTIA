                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <h1 class="text-center text-2xl flex items-center">
                            <img src="https://i.pinimg.com/originals/05/7b/27/057b274c134bcf92ac151758478949b3.png" alt="Shopee Logo" class="logo mr-2">
                        </h1>
                        <div class="flex items-center">
                            ...
                            <Link href="/products" class="text-gray-500 hover:text-gray-700 mr-4">Products</Link>
...
<style scoped>
    .custom-bg-orange {
        background: linear-gradient(to bottom, rgb(243, 81, 17), white);
    }
